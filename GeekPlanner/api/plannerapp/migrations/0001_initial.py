# Generated by Django 2.2 on 2019-09-01 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='activity')),
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='project_participation_set', to='plannerapp.Project', verbose_name='project')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_participation_set', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
